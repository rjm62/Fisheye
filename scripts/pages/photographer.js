async function getPhotographers() {
    ...
    let medias = recovery["media"];
               ...
               for(let i=0; i<photographersData.length; i++) {
                ...
                let photographerElement =photographElementsArray.id;
                    if(photographerElement==photographerId){
                        ...
                        console.log(photographElementsArray);
                        console.log(photographerElement);
                        console.log("ehhhhh ben ça été dur!!!!!!!");
        ...
        async function getMediasCard(mediasData,name) {
            ...
            const photograpMedia = document.createElement("photograph-media");
            ...
            for(let j=0; j<mediasElementArray.length; j++) {
                if(mediasElementArray[j].photographerId == photographerId) {
                    const mediaCards = document.createElement("mediacards");
                    ...
                    const mediaTitle = document.createElement("mediaTitle");           // ajout du titre de la photo        
                    mediaTitle.textContent = mediasElementArray[j].title;
                    
                    const likesContainer = document.createElement("likesContainer");   // création du conteneur  pour nombre de "like"
                    likesContainer.style.display = "flex";
                    likesContainer.style.width = "12%"
